...
import { getMonthesNames, createMonth, getWeekDaysNames, getMonthNumberOfDays, createDate } from '../utils';
...
export const useCalendar = ({ locale = 'default', selectedDate: date, firstWeekDayNumber = 2 }) => {
	...
	const setSelectedMonthByIndex = (monthIndex, year) => {
		setSelectedMonth(createMonth({ date: new Date(year ?? selectedYear, monthIndex), locale }));
	};
