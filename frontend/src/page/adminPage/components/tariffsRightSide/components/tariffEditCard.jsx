...
const TariffEditCardContainer = ({ className, item, setIsEdit }) => {
			...
			<div className="tariff-card-main">
				<div className="tariff-card-header">
					...
					<div style={{ display: 'flex' }}>
						<Icon height="25px" name={ICON.CROSS} onClick={() => setIsEdit(false)} />
					</div>
				</div>
				<textarea
...
export const TariffEditCard = styled(TariffEditCardContainer)`
	display: flex;
